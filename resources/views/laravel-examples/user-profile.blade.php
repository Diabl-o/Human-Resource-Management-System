    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editImageModalLabel"> Profile Picture preview</h5>
            ...
            <div class="modal-body">
                <div id="imageContainer">
                    <img id="editedImage" src="" alt="Edited Image" class="w-100 border-radius-lg shadow-sm h-100">
                </div>
            </div>
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        ...
                        $imageData = auth()->user()->image_blob;
                        $imageType = auth()->user()->image_type;
                        $base64Image = 'data:' . $imageType . ';base64,' . base64_encode($imageData);
                    @endphp
                        
                        <img src="{{$base64Image}}" id="preview" alt="..." class="w-100 border-radius-lg shadow-sm h-100" style="object-fit: cover">
                        <a href="#" id="edit_image"  class="btn btn-sm btn-icon-only bg-gradient-light position-absolute bottom-0 end-0 mb-n2 me-n2">
                            <i class="fa fa-pen top-0" data-bs-toggle="tooltip" data-bs-placement="top" title="Change Profile Picture"></i>
                        </a>
                        <form action="{{ route('edit_image') }}" method="post" enctype="multipart/form-data" id="uploadForm">
                            @csrf
                            <label for="Image" style="display: none">Choose an image:</label>
                            <input type="file" id="image_upload" name="image" style="display: none;">
                        </form>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('first_name')border border-danger rounded-3 @enderror">
                                    <input class="form-control" value="{{ auth()->user()->first_name }}" type="text" placeholder="First Name" id="user-name" name="first_name">
                                </div>
                                        @error('first_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.last_name') border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="text" placeholder="Last Name" id="user-name" name="last_name" value="{{ auth()->user()->last_name }}">
                                    @error('last_name')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="@error('user.phone')border border-danger rounded-3 @enderror">
                                    <input class="form-control" type="tel" placeholder="98XXXXXXXX" id="number" name="phone" value="{{ auth()->user()->phone1 }}">
                                        @error('phone')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                        @enderror
                                </div>
